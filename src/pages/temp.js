...
const IndexPage = () => (
  <Layout>
    ...
    {/* <h1>REHATCHER</h1>
    <p>Welcome to REHATCHER.</p>
    <p>Business Rebirth.</p>
    <StaticImage
    ...
    {/* <header class="bgimg-1 w3-display-container w3-grayscale-min" id="home"> */}
      ...
      >
        ...
        <a href="#work" click={w3_close} class="w3-bar-item w3-button">
          WORK
        </a>
        <a href="#pricing" click={w3_close} class="w3-bar-item w3-button">
          PRICING
        </a>
        <a href="#contact" click={w3_close} class="w3-bar-item w3-button">
          CONTACT
        </a>
      </nav>
        ...
        <div class="w3-col m6">
          ...
          <p>
            <a href="#work" class="w3-button w3-black">
              <i class="fa fa-th"> </i> View Our Works
            </a>
          </p>
        </div>
        <div class="w3-col m6">
